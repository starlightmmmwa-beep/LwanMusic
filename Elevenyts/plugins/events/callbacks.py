...
async def _help(_, query: types.CallbackQuery):
    ...
    help_texts = {
        ...
        "play": "<u><b>ᴘʟᴀʏ ᴄᴏᴍᴍᴀɴᴅꜱ:</b></u>\nʏᴏᴜ ᴄᴀɴ ᴘʟᴀʏ ᴍᴜꜱɪᴄ ɪɴ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴜꜱɪɴɢ ᴛʜᴇ ꜰᴏʟʟᴏᴡɪɴɢ ᴄᴏᴍᴍᴀɴᴅꜱ.\n/play [ꜱᴏɴɢ ɴᴀᴍᴇ/ʏᴛ ᴜʀʟ/ʀᴇᴘʟʏ ᴛᴏ ᴀᴜᴅɪᴏ]: ᴘʟᴀʏ ᴀᴜᴅɪᴏ ɪɴ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.\n/vplay [ꜱᴏɴɢ ɴᴀᴍᴇ/ʏᴛ ᴜʀʟ/ʀᴇᴘʟʏ ᴛᴏ ᴠɪᴅᴇᴏ]: ᴘʟᴀʏ ᴠɪᴅᴇᴏ ɪɴ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.\n/cplay [ꜱᴏɴɢ/ᴜʀʟ]: ᴘʟᴀʏ ᴀᴜᴅɪᴏ ɪɴ ʟɪɴᴋᴇᴅ ᴄʜᴀɴɴᴇʟ.\n/cvplay [ꜱᴏɴɢ/ᴜʀʟ]: ᴘʟᴀʏ ᴠɪᴅᴇᴏ ɪɴ ʟɪɴᴋᴇᴅ ᴄʜᴀɴɴᴇʟ.\n/playforce: ꜰᴏʀᴄᴇ ᴘʟᴀʏ ᴀᴜᴅɪᴏ.\n/vplayforce: ꜰᴏʀᴄᴇ ᴘʟᴀʏ ᴠɪᴅᴇᴏ.\n/radio: ᴘʟᴀʏ ᴏɴʟɪɴᴇ ʀᴀᴅɪᴏ ꜱᴛᴀᴛɪᴏɴꜱ.",
